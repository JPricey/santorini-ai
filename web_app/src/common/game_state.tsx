...
export const WIP_GODS: Set<GodType> = new Set([God.Chronus3T, God.Chronus4T]);
...
export function getPlayerOnSquare(
    gameState: GameState,
    square: SquareType,
): PlayerType | null {
...
export function getTokenOnSquare(
    gameState: GameState,
    square: SquareType,
): PlayerType | null {
    const squareStr = squareToSquareStr(square);
...
export function squareStrToSquare(
    squareStr: string,
): Result<SquareType, string> {
